    ...
    if (this.props.airData[0]) {
      return (
        <div>
          ...
          <h1 className="a-city">{this.props.airData[0].data.city.name}</h1>
          <div className="main-meter animated bounceIn" style={{color: `${this.props.color}`}}>
            <h3 className="a-title font-family: 'Passion One', cursive; font-size: 2.0rem; font-weight: 200;">PM2.5</h3>
